"""Synchronous multi-item Cosmos repository for Flask and Gunicorn."""
...
class CosmosConversationRepository(ConversationRepository):
    ...
    def list_conversations(self, user_id: str) -> list[ConversationRecord]:
        ...
        items = self._container.query_items(query=query, partition_key=user_id)
...
def create_cosmos_repository() -> CosmosConversationRepository:
    """Create one reusable Cosmos client and repository during app startup."""
